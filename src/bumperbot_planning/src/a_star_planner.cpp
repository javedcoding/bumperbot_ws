...
nav_msgs::msg::Path AStarPlanner::plan(const geometry_msgs::msg::Pose & start, geometry_msgs::msg::Pose & goal)
{
    ...
    while(!pending_nodes.empty() && rclcpp::ok()){
        ...
        visited_map_.data.at(poseToCell(active_node)) = -106; //put the occupancy grid to make it visited as orange in rviz map
